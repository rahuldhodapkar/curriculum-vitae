...
\begin{longtable}{r|p{11cm}}
 ...
 \nopagebreak & \footnotesize{
	\begin{itemize}
		\item[]{
			...
			using MongoDB to store medical sensor data for over 1000
 ...
 \multicolumn{2}{c}{} \\
 \nopagebreak \textsc{Jul 2013} & Research and Development Intern at \textsc{Epic Systems}\\
 ...
 \multicolumn{2}{c}{} \\
 \nopagebreak \textsc{Jul 2012} & Software Development Intern at \textsc{VantageLocal}, \small\emph{(now \textsc{Frequence})}\\
 \nopagebreak \textsc{May 2012} & \small{Palo Alto, CA, USA}\\
 \nopagebreak & \footnotesize{
	\begin{itemize}
		\item[]{
			Developed a web application to automate quote generation for
			locally targeted, real time bid (RTB) advertising for over 43,000
			U.S. zip codes.
		}
		\item[]{
